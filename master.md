# Alexander Ferrari Miller — Master Résumé

> **Source-of-truth document**
>
> This file is the master career record used to create targeted résumés. It intentionally preserves broad experience and incomplete historical information rather than inventing missing dates or details. Published résumés should select and emphasize material from this file according to their intended audience.

## Professional Summary

Versatile professional with experience spanning software quality assurance, software development, insurance, sales, education, transportation, customer service, hospitality, web development, publishing, fundraising, and live performance.
...
- Hired by World Financial Group for insurance and financial-services sales.
- Holds an active California Resident Insurance Producer License.
- Current status is hired but not yet appointed.
- Developing insurance-sales, prospecting, presentation, relationship-building, and client-communication activities.
- Do not describe this position as involving completed insurance transactions or carrier appointment unless and until those activities occur.
...
- Interacted with children, families, photographers, managers, and other members of the Santa team.
- Maintained character throughout long, high-volume shifts.
- Helped create positive and memorable experiences for families while working effectively as part of a team.
...
- Transported passengers safely and professionally throughout the Los Angeles area.
- Provided courteous customer service to passengers from a wide variety of backgrounds.
- Navigated efficiently using knowledge of local streets and electronic navigation.
- Handled fares, payments, passenger requests, and changing destinations.
- Maintained professional conduct while working independently.
...
- Provided passenger transportation throughout the greater Los Angeles area.
- Completed thousands of independent customer-service interactions in a highly variable working environment.
- Used navigation, rideshare, payment, and smartphone systems in daily operations.
- Managed time, routes, passenger communication, pickups, and drop-offs independently.
- Maintained professionalism and customer service during high-volume and time-sensitive situations.
...
- Set up and broke down bar operations.
- Served customers in a professional hospitality environment.
...
- Designed, developed, and maintained website content.
...
- Researching and writing a long-term astronomy reference work.
...
- Independently developed spreadsheet-based astronomical calculations for determining when individual stars are most favorably placed for observation.
- Uses the transit of a star across the local meridian at 9:00 PM local apparent time as the astronomical criterion for optimal seasonal placement.
- Combines astronomical calculation with explanatory narrative intended to make technical concepts and conventions understandable.
...
- Employed by Ruffalo Cody under its contract with the University of Massachusetts Lowell.
- Made outbound telemarketing calls to UMass Lowell alumni to solicit charitable donations.
- Worked from established telephone scripts.
- Responded to questions and handled objections from alumni.
- Directly asked alumni to make financial contributions.
- Worked in a monitored telephone-fundraising environment in which recorded calls were periodically reviewed for performance.
...
- Presented to prospective customers attending as part of a promotional prize program.
- Explained the timeshare offering and answered prospective buyers' questions.
- Transitioned prospects to a manager who was responsible for closing sales.
- Worked primarily from Framingham, Massachusetts; occasionally traveled to Stowe, Vermont, to experience the facility being presented.
...
- Bagged customers' groceries.
- Assisted customers by loading groceries into their vehicles as they drove up.
- Provided direct customer service in a grocery-store environment.
...
- Delivered newspapers to customers on an assigned route.
- Interacted directly with subscribers.
- Collected subscription payments from customers.
- Handled cash and reconciled collected payments.
- Worked the route during the period when the Susan B. Anthony dollar was newly introduced.
...
The reconstruction occurred before the current GitHub-based preservation methodology was established.
...
Insurance sales, sales presentations, prospect communication, relationship building, telephone fundraising, outbound calling, objection handling, customer service, public speaking, software quality assurance, software testing, test design, test-tool development, defect analysis, bug tracking, white-box testing, black-box testing, boundary-condition testing, regression testing, usability analysis, reproducibility analysis, software development, algorithm design, cryptographic software, Ada, SQL, database analysis, Microsoft Access, Linux and Unix environments, web development, Laravel, Server-Side Includes (SSI), troubleshooting, web design and administration, technical writing, independent research, computational astronomy, spreadsheet modeling, Microsoft Excel, Microsoft Office, LibreOffice, Adobe Acrobat, data entry, POS systems, cash-register operations, credit-card payment processing, telephone communication, in-person sales presentations, classroom management, teaching, driving, navigation, time management, attention to detail, interpersonal communication, acting, character performance, singing, choral singing, musical theater, opera, dance, and live audience interaction.

## Targeted Résumé Policy

The master résumé is not intended to be published directly.

Four targeted résumés are derived from this file:

**Insurance / Sales**  
Insurance licensing, WFG, sales, fundraising, presentation, prospect communication, objection handling, and relationship-building experience. Customer-service experience supports the sales narrative but should not dominate it.

**Customer Service / Retail / Hospitality**  
Customer service, retail, hospitality, transportation, POS/payment handling, high-volume public interaction, and problem solving.

**Technical / QA / Software**  
Software quality assurance, software development, testing, troubleshooting, technical research, web technology, computational work, and current technical projects.

**Performance**  
Professional character performance, acting, musical theater, opera, singing, dance, and live audience interaction.

The HTML and DOCX versions of each targeted résumé should be generated from the same underlying content so they remain synchronized.

## Published Résumé Filenames

- `resumes/insurance-sales-resume.html`
- `resumes/insurance-sales-resume.docx`
- `resumes/customer-service-resume.html`
- `resumes/customer-service-resume.docx`
- `resumes/technical-resume.html`
- `resumes/technical-resume.docx`
- `resumes/performance-resume.html`
- `resumes/performance-resume.docx`

## Baseline Notes / Information Still to Recover

This master intentionally preserves incomplete information rather than inventing dates or details.
